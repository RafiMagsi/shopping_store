...
class _Img {
  static const headphones = 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=600&h=600&fit=crop&q=80';
  static const sneakers   = 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600&h=600&fit=crop&q=80';
  static const watch      = 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=600&h=600&fit=crop&q=80';
  static const laptop     = 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=600&h=600&fit=crop&q=80';
  static const handbag    = 'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=600&h=600&fit=crop&q=80';
  static const fragrance  = 'https://images.unsplash.com/photo-1541643600914-78b084683702?w=600&h=600&fit=crop&q=80';
  static const camera     = 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=600&h=600&fit=crop&q=80';
  static const dress      = 'https://images.unsplash.com/photo-1539109136881-3be0616acf4b?w=600&h=600&fit=crop&q=80';
  static const sunglasses = 'https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=600&h=600&fit=crop&q=80';
  static const ring       = 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=600&h=600&fit=crop&q=80';
  static const speaker    = 'https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=600&h=600&fit=crop&q=80';
  static const tablet     = 'https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=600&h=600&fit=crop&q=80';
  static const jacket     = 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=600&h=600&fit=crop&q=80';
  static const shoes2     = 'https://images.unsplash.com/photo-1600185365926-3a2ce3cdb9eb?w=600&h=600&fit=crop&q=80';
  static const airpods    = 'https://images.unsplash.com/photo-1606741965326-cb990ae01bb2?w=600&h=600&fit=crop&q=80';

  // Hero banner images (portrait format)
  static const hero1 = 'https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=800&h=1100&fit=crop&q=85';
  static const hero2 = 'https://images.unsplash.com/photo-1468495244123-6c6c332eeece?w=800&h=1100&fit=crop&q=85';
  static const hero3 = 'https://images.unsplash.com/photo-1491553895911-0055eca6402d?w=800&h=1100&fit=crop&q=85';
}
...
class HomeMockData {
  ...
  List<Product> get hotDeals => const [
    Product(
      id: 'p1', name: 'AirPods Pro Max', brand: 'Apple',
      price: 449, originalPrice: 599, rating: 4.9, reviews: 2841,
    ...
    Product(
      ...
      price: 159, originalPrice: 220, rating: 4.7, reviews: 1203,
    ...
    Product(
      ...
      price: 1899, originalPrice: 2400, rating: 4.9, reviews: 412,
    ...
    Product(
      ...
      price: 1799, originalPrice: 2199, rating: 4.9, reviews: 3201,
    ...
    Product(
      ...
      price: 1250, originalPrice: 1550, rating: 4.8, reviews: 621,
    ...
    Product(
      ...
      price: 180, originalPrice: 240, rating: 4.8, reviews: 1876,
  ...
  List<Product> get flashSaleItems => const [
    Product(
      id: 'f1', name: 'Sony WH-1000XM5', brand: 'Sony',
      price: 198, originalPrice: 399, rating: 4.9, reviews: 5420,
    ...
    Product(
      ...
      price: 129, originalPrice: 220, rating: 4.8, reviews: 4210,
    ...
    Product(
      ...
      price: 499, originalPrice: 749, rating: 4.9, reviews: 2987,
  ...
  List<Product> get trending => const [
    Product(
      id: 't1', name: 'Dyson V15', brand: 'Dyson',
      price: 549, originalPrice: 699, rating: 4.7, reviews: 1203,
      soldPercent: 0,
    ...
    Product(
      ...
      price: 279, originalPrice: 350, rating: 4.8, reviews: 3421,
      soldPercent: 0,
    ...
    Product(
      ...
      price: 1599, originalPrice: 1799, rating: 4.9, reviews: 876,
      soldPercent: 0,
    ...
    Product(
      ...
      price: 450, originalPrice: 490, rating: 4.9, reviews: 234,
      soldPercent: 0,
    ...
    Product(
      ...
      price: 2800, originalPrice: 3200, rating: 5.0, reviews: 189,
      soldPercent: 0,
    ...
    Product(
      ...
      price: 1950, originalPrice: 2200, rating: 4.8, reviews: 312,
      soldPercent: 0,
  ...
  List<String> get brands => [
    'APPLE', 'NIKE', 'CHANEL', 'LOUIS VUITTON', 'GUCCI',
    'ROLEX', 'PRADA', 'HERMÈS', 'ADIDAS', 'SONY',
  ];
}
